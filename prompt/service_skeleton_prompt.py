...
def convert_service_skeleton_code(procedure_data, spFile_Name, command_class_name):
    ...
    result = chain.invoke({"procedure_json": procedure_json, "proejct_name": spFile_Name, "command_class_name": command_class_name})
    return result