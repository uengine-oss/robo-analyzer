...
5. 데이터 타입 매핑
   ...
   - DECIMAL, FLOAT, DOUBLE, REAL -> Float 또는 Numeric
...
===============================================
from sqlalchemy import Column, Integer, String, Boolean, DateTime, Date, Float, Numeric, LargeBinary
...
# 매개변수: 
#   - table_data : 테이블 노드의 메타데이터 정보
#   - orm_type : 사용할 ORM 유형 (JPA, MyBatis, sqlalchemy 등)
#
# 반환값: 
#   - result : LLM이 생성한 Entity 클래스 정보
def convert_entity_code_python(table_data: dict) -> dict:
