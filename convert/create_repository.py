...
{merged_methods}
    ...
    """
        ...
        repository_interface_directory = os.path.join(base_directory, 'converting_result', f'{fileName}', 'src', 'main', 'java', 'com', 'example', f'{fileName}','repository')
        os.makedirs(repository_interface_directory, exist_ok=True)
        file_path = os.path.join(repository_interface_directory, f"{repository_pascal_name}Repository.java")
...
# 반환값: JPA 메서드 리스트
async def start_repository_processing(table_node_list, sp_fileName):
